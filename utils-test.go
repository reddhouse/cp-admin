...
// Make an API call to signup a new user.
func (u *utils_test) signupNewUser(args ...string) {
	...
	var jsonData = []byte(`{"email":"` + randomEmail + `"}`)
